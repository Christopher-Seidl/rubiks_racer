...
void Cube::rotate_face(CubeFace face, Rotation rotation) {
  ...
  case CubeFace::TOP: {
    ...
    case Rotation::CLOCKWISE:
      top().rotate_face(Rotation::CLOCKWISE);
    ...
    case Rotation::COUNTER_CLOCKWISE:
      top().rotate_face(Rotation::COUNTER_CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
        Square temp = front().m_squares[0][i];
  ...
  case CubeFace::BOTTOM: {
    switch (rotation) {
    case Rotation::CLOCKWISE:
      bottom().rotate_face(Rotation::CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
      ...
      return;
    case Rotation::COUNTER_CLOCKWISE:
      bottom().rotate_face(Rotation::COUNTER_CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
        Square temp = front().m_squares[2][i];
  ...
  case CubeFace::FRONT: {
    switch (rotation) {
    case Rotation::CLOCKWISE:
      front().rotate_face(Rotation::CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
      ...
      return;
    case Rotation::COUNTER_CLOCKWISE:
      front().rotate_face(Rotation::COUNTER_CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
        Square temp = top().m_squares[2][i];
  ...
  case CubeFace::BACK: {
    switch (rotation) {
    case Rotation::CLOCKWISE:
      back().rotate_face(Rotation::CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
      ...
      return;
    case Rotation::COUNTER_CLOCKWISE:
      back().rotate_face(Rotation::COUNTER_CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
        Square temp = top().m_squares[0][i];
  ...
  case CubeFace::LEFT: {
    switch (rotation) {
    case Rotation::CLOCKWISE:
      left().rotate_face(Rotation::CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
      ...
      return;
    case Rotation::COUNTER_CLOCKWISE:
      left().rotate_face(Rotation::COUNTER_CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
        Square temp = top().m_squares[i][0];
  ...
  case CubeFace::RIGHT: {
    switch (rotation) {
    case Rotation::CLOCKWISE:
      right().rotate_face(Rotation::CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
      ...
      return;
    case Rotation::COUNTER_CLOCKWISE:
      right().rotate_face(Rotation::COUNTER_CLOCKWISE);
      for (size_t i = 0; i < 3; i++) {
        Square temp = top().m_squares[i][2];
